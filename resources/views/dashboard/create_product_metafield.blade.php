...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="page-title">Create product metafield</h1>
                </div>
        ...
        <form id="create_product_metafield">
            ...
            <div class="card card-primary">
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="value_type">Select Product</label>
                                <select class="form-select" name="product_id" id="product_id" aria-label="Select product">
