...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="page-title">Create variant metafield</h1>
                </div>
        ...
        <form id="create_variant_metafield">
            ...
            <div class="card card-primary">
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="value_type">Product</label>
                                <select class="form-select product_select" name="product_id" id="product_id" aria-label="Select Product">
                                  ...
                                  <span id="product_id-error"></span>
                            </div>
                            <div class="form-group">
                                <label for="variant">Variant</label>
                                <select class="form-select select-variant" name="variant_id" id="variant_id" aria-label="Select Variant" disabled>
                                </select>
                                <span id="variant_id-error"></span>
                            </div>
                            <div class="form-group">
...
@section('scripts')
    ...
    <script>
        actions.TitleBar.create(app, { title: 'Create Variant' });
    </script>
@endsection